...
BOOT_LOGO = tf919_oq_s89_6833_r0_eea_hdplus1600
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_MODEM=tf919_6833_r0_nlwcg
...
#camera
CUSTOM_HAL_IMGSENSOR = imx582_mipi_raw ov20880_mipi_raw imx314_mipi_raw gc02m2_mipi_raw gc032a_mipi_raw gc8034_mipi_raw gc5035_mipi_raw gc02m1_mipi_raw ov8858_mipi_raw imx362_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = imx582_mipi_raw gc8034_mipi_raw imx362_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR =  ov20880_mipi_raw imx314_mipi_raw ov8858_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = 

CUSTOM_KERNEL_IMGSENSOR = imx582_mipi_raw ov20880_mipi_raw imx314_mipi_raw gc02m2_mipi_raw gc032a_mipi_raw gc8034_mipi_raw gc5035_mipi_raw gc02m1_mipi_raw ov8858_mipi_raw imx362_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx582_mipi_raw gc8034_mipi_raw imx362_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR =  ov20880_mipi_raw imx314_mipi_raw ov8858_mipi_raw
...
WTK_BUILD_VERNO = OUKITEL_WP15_EEA_V09_20211014
WTK_INTERNAL_BUILD_VERNO = TF919_OQ_S89_6833_R0_EEA_V1.9.7.2_S211014
...
FINGERPRINT_SUNWAVE_REE_9722=no
FINGERPRINT_SUNWAVE_FS9722_TRUSTKERNEL_TEE=yes

#add by liulei for gms 20210428 start
BUILD_GMS = yes
WTK_CLIENTID_CUSTOM = wheatek
WTK_TARGET_BOARD_NAME = OUKITEL
CUSTOM_GMS_TYPE = eean
CUSTOM_CAMERA_NOTCH = yes
WTK_CAMERA_SUPPORT_IMAGE_N=3
WTK_UNSUPPORT_ACSA=yes
CUSTOM_CAMERA_NOTCH = yes
#add by liulei for gms 20210428 end

WTK_FILEMANAGER_APP = yes
WTK_TOOL_BOX_SUPPORT = yes

#add Bug_id:TFJYJ-148 chenyu 20210506 start
ODM_SIDE_KEY_SUPPORT = yes
#add Bug_id:TFJYJ-148 chenyu 20210506 end

#add cyee feature start 
ODM_CYEEFRAMEWORK_SUPPORT = yes
CYEE_CALCULATOR_SUPPORT = yes
CYEE_FLASHLIGHT_SUPPORT = yes
CYEE_NOTE_SUPPORT = yes
ODM_CYEE_SYSTEMMANAGER_SUPPORT = yes

CY_CAMERA_FEATURE_SUPPORT = yes
CY_CHENYEE_FEATURE_SUPPORT = yes
CY_CHENYEE_MARKEFFECT_SUPPORT = yes
CY_OMRON_FEATURE_SUPPORT = yes
CY_OMRON_BEAUTY_SUPPORT = yes
CY_MORPHO_FEATURE_SUPPORT = yes
CY_MORPHO_SINGLE_BOKEH_SUPPORT = yes
#add cyee feature end 

#add pi feature start 
PI_CAMERA_FEATURE_SUPPORT = yes
PI_CAMERA_PANORMA_SUPPORT = no
PI_CAMERA_BEAUTY_SUPPORT = no
PI_CAMERA_BOKEH_SUPPORT = no
PI_CAMERA_HDR_SUPPORT = yes
PI_CAMERA_NIGHT_SUPPORT = yes
PI_CAMERA_SCENE_SUPPORT = yes
PI_CAMERA_LDC_SUPPORT = no
#add pi feature end 

#add by jinhui.li TFJYJ-203 start
WTK_PICTURE_MAKER = OUKITEL
CHROME_CUSTOMIZATIONS_PACKAGES = yes
WTK_SYS_TIMEZONE = Europe/London
#add by jinhui.li TFJYJ-203 end

#add bug:TFJYJ-284 wushanfei 20210511 start
CUSTOM_DEFAULT_RINGTONE=Fluorune.ogg
CUSTOM_DEFAULT_ALARM_ALERT=Ringingtone_alarm.ogg
CUSTOM_DEFAULT_NOTIFICATION_SOUND=WaterDrop.ogg
#add bug:TFJYJ-284 wushanfei 20210511 end

#FACE_UNLOCK_SUPPORT start
FACE_UNLOCK_SUPPORT = yes
#FACE_UNLOCK_SUPPORT end

#add bug:none wushanfei 20210513 start
WTK_OVERRIDES_ORIGINAL_MUSIC = yes
#add bug:none wushanfei 20210513 end
...
WTK_CUSTOM_SIGNAL = oq
#add custom signal end

#add by chenyu for WakeGesture 20210608 start
WTK_APP_WAKE_GESTURE_SUPPORT = yes
WTK_CHILD_MODE_SUPPORT = yes
#add by chenyu for WakeGesture 20210608 end

#add TEWBW-2046 xudong.zhang 20200925(start)
WTK_GAME_MODE_SUPPORT = yes
#add TEWBW-2046 xudong.zhang 20200925(end)
CYEE_LONGSCREENSHOT_SUPPORT = yes

#add sos app by zhangxudong 20210619(start)
WTK_SOS_APP_SUPPORT = yes
#add sos app by zhangxudong 20210619(end)

WTK_QUICK_CHARGE_SUPPORT = yes
...
PLATFORM_BASE_OS = OUKITEL/WP15_EEA/WP15:11/RP1A.200720.011/1627032687:user/release-keys
